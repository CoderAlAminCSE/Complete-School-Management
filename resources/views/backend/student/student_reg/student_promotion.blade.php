                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="controls">
                                               <img id="showImage" src="{{(!empty($editData['student']['image'])) ? url('upload/student_image/'.$editData['student']['image']):url('upload/no_image.jpg')}}" alt="" style="height: 100px;height:100px">
                                            </div>
                                        </div>
                                    </div>
                                </div>

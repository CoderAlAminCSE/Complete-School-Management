                      ...
                      <tbody>
                          @foreach ($allData as $key=>$assign)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('edit.assign.subject',$assign->class_id)}}" class="btn btn-info">Edit</a>
                                    <a href="{{route('assign.subject.details',$assign->class_id)}}" class=" btn btn-danger">Detsils</a>
                                </td>
                            </tr>
                          @endforeach

                      ...
                      <tbody>
                          @foreach ($allData as $key=>$allData)
                            <tr>
                                ...
                                <td>{{$allData->name}}</td>
                                <td>
                                    <a href="{{route('student.shift.edit',$allData->id)}}" class="btn btn-info">Edit</a>
                                    <a href="{{route('student.shift.delete',$allData->id)}}" class=" btn btn-danger" id="delete">Delete</a>
                                </td>
                            </tr>
                          @endforeach

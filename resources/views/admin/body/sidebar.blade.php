    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{($prefix == '/students')?'active':''}}">
          <a href="#">
            <i data-feather="mail"></i> <span>Manage Student</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview {{($prefix == '/employees')?'active':''}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{($route == 'employee.attendence.view')?'active':''}}"><a href="{{route('employee.attendence.view')}}"><i class="ti-more"></i>Employee Attendance</a></li>
        ...
        <li class="treeview {{($prefix == '/marks')?'active':''}}">
          ...
          <ul class="treeview-menu">
            <li class="{{($route == 'marks.emntry.view')?'active':''}}"><a href="{{route('marks.emntry.view')}}"><i class="ti-more"></i>Marks Entry</a></li>
            <li class="{{($route == 'marks.entry.edit')?'active':''}}"><a href="{{route('marks.entry.edit')}}"><i class="ti-more"></i>Marks Edit</a></li>
            <li class="{{($route == 'marks.entry.grade')?'active':''}}"><a href="{{route('marks.entry.grade')}}"><i class="ti-more"></i>Grade Entry</a></li>
          </ul>
        </li>	
        ...
        <li class="treeview {{($prefix == '/accounts')?'active':''}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{($route == 'employee.salary.view')?'active':''}}"><a href="{{route('employee.salary.view')}}"><i class="ti-more"></i>Employee Salary</a></li>
            <li class="{{($route == 'other.cost.view')?'active':''}}"><a href="{{route('other.cost.view')}}"><i class="ti-more"></i>Others Cost</a></li>
          </ul>
        </li>	
        ...
        <li class="treeview {{($prefix == '/reports')?'active':''}}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{($route == 'marksheet.generate.view')?'active':''}}"><a href="{{route('marksheet.generate.view')}}"><i class="ti-more"></i>Marksheet Genrerate</a></li>
            <li class="{{($route == 'attendance.report.view')?'active':''}}"><a href="{{route('attendance.report.view')}}"><i class="ti-more"></i>Attendance Repory</a></li>

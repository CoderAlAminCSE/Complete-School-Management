...
class StudentRegController extends Controller
{
    ...
    public function StudentUpdatePromotion(Request $request,$student_id){
        ...
        $notification  = array(
            'message'=> 'Student Promotion Successfully',
            'alert-type'=>'success'
        );
        return redirect()->route('student.registration.view')->with($notification);
    }
    ...
    public function StudentRegDetails($student_id){
        $data['details'] = AssignStudent::with(['student','discount','student_year','student_class'])->where('student_id',$student_id)->first();

        $pdf = PDF::loadView('backend.student.student_reg.student_edtails_pdf', $data);

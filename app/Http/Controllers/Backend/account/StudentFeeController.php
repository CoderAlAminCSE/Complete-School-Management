...
class StudentFeeController extends Controller
{
 ...
 $accountstudentfees = StudentAccountFee::where('student_id',$std->student_id)->where('year_id',$std->year_id)->where('class_id',$std->class_id)->where('fee_category_id',$fee_category_id)->where('date',$date)->first();
 ...
 if($accountstudentfees !=null) {
    ...
    public function StudentFeeStore(Request $request){
    	...
    	StudentAccountFee::where('year_id',$request->year_id)->where('class_id',$request->class_id)->where('fee_category_id',$request->fee_category_id)->where('date',$request->date)->delete();
